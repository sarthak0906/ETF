...
class LoadWeightsFromMongoDB(object):
	...
	def getWeightsFromMongoDB(self,ticker=None,date=None):
		# Taking in ETF List - TODO Call @Piyush Method Here to Get Data in holdings
...
class RunArbitrage(object):
	...
	def __init__(self,date=None,previousdate=None,starttime='9:30:00',endtime='17:00:00',endtimeLoop='16:00:00',etfticker=None):
		self.date=date
		...
		self.marketTimeStamps=Helper().convertStringDateToTS(date=self.date,starttime=self.starttime,endtime=self.endtime)
...
if __name__=="__main__":
	...
	RunarbitrageObject=RunArbitrage(date=date,previousdate=previousdate,starttime='9:30:00',endtime='17:00:00',endtimeLoop='16:00:00',etfticker=etfticker)
	tradePricesDF,quotesSpreadDF=RunarbitrageObject.runHistoricalArbitrageCalculations()
	
	for i in range(9,16):
	    print("Hour at="+str(i))
	    res=RunarbitrageObject.getMeHourdata(getmeHourDataFor=i,tradePricesDF=tradePricesDF,quotesSpreadDF=quotesSpreadDF)
