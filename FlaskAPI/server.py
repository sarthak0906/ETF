...
# Production Server
# READ ONLY ACCESS
connection = connect('ETF_db', alias='ETF_db', host='18.213.229.80', port=27017, username='usertesterReadOnly', password='onlyreadpass')
############################################
...
def FetchPastArbitrageData(ETFName, date):
    ...
    print("Price Df")
    print(pricedf)
    PNLStatementForTheDay = pd.DataFrame(PNLStatementForTheDay.items()).to_dict(orient='records')
