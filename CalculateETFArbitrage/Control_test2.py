...
class RunArbitrage(object):
    ...
    def giveArbitrageResults(self,tickHistDataTrade,tickHistDataQuotes):
        helperObj = Helper()
...
if __name__ == "__main__":
    ...
    CallPolygonApiObject = CallPolygonApi(date=date,symbols=etfData.getSymbols())
    tradePricesDF, quotesSpreadDF = CallPolygonApiObject.assemblePolygonData()
