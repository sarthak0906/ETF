      ...
      <Navbar className="bg-dark">
        <Form inline >
            <Form.Group onChange={select}>
              ...
              <Form.Control className="FormInput" as="select" value={props.ETF}>
                {FormSelect(arr)}
              </Form.Control>
            </Form.Group>
            <DatePicker
